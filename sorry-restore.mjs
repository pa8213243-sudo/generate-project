...
const files = [
  // ==========================================
  // 1. GLOBE WIDGET (Restoring the Original Cyan Glowing Earth)
  // ==========================================
  {
...
export const GlobeWidget = () => {
  return (
    <div className="relative w-full h-full flex flex-col items-center justify-between rounded-2xl bg-[#0B1120] border border-white/10 overflow-hidden shadow-2xl p-6 min-h-[350px]">
      ...
      <div className="relative z-10 flex-1 flex items-center justify-center w-full">
        <div className="relative w-full max-w-[280px] aspect-square rounded-full shadow-[0_0_80px_rgba(34,211,238,0.4),inset_-20px_-20px_60px_rgba(0,0,0,0.9)] bg-[#050816] overflow-hidden border border-cyan-500/30 flex items-center justify-center">
          <div 
  ...
  // ==========================================
  // 2. PAGE.TSX (Restoring Heatmap & Adding ONLY the 3D Buttons)
  // ==========================================
  {
    path: 'app/page.tsx',
    content: `"use client";
  ...
  return (
    <div className={\`w-full p-6 space-y-6 max-w-[1600px] mx-auto \${devMode ? 'border border-dashed border-accent/50' : ''}\`}>
      ...
      <div className="w-full flex items-center justify-between bg-[#0B1120] border border-white/10 rounded-2xl px-6 py-4 shadow-lg">
        ...
        {/* RIGHT HEADER: ONLY THE REQUESTED 3D BUTTONS */}
        <div className="flex items-center gap-4">
          
          {/* 3D BLUE VIEW PROJECTS BUTTON */}
          <Link 
            href="/projects" 
            className="hidden lg:flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs font-mono transition-all cursor-pointer bg-blue-600 text-white font-bold border border-blue-400 shadow-[0_4px_0_#1e3a8a,0_4px_10px_rgba(37,99,235,0.4)] active:translate-y-1 active:shadow-none hover:bg-blue-500"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 w-full items-stretch">
        ...
        <div className="flex flex-col gap-6 h-full">
          ...
          {/* RESTORING ORIGINAL BEAUTIFUL HEATMAP */}
...
async function applyRestore() {
  ...
  console.log('\\n🎉 SUCCESS: All "faltu" experimental designs removed. Back to the masterpiece with the 2 exact 3D buttons you asked for.');
}
