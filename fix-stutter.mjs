    ...
    setTimeout(() => {
      ...
      const interval = setInterval(() => {
        setMessages(prev => {
          ...
          // FIX: Deep copy to prevent React Strict Mode from double-appending characters
          newMessages[lastIdx] = { 
            ...newMessages[lastIdx], 
            text: newMessages[lastIdx].text + aiResponse.charAt(i) 
          };
